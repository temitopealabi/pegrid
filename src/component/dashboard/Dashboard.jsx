...
const listConsumption = [{ id: 1, title: 'Residential', unit: '₦', rate: '25.73', textF: '', percentChange: '+₦2.4(10%)', unitTile: 'per kWh', rateF: 'h4 ', bg: 'backResi', signBg: 'h6' },
      ...
      <button className="btn btn-outline-success my-2 my-sm-0 d-none" type="submit">Search</button>
                    ...
                    <div className="row">
                                ...
                                <Content
                                    ...
                                    <div className="px-1 ">
                                        <div>
                                            ...
                                            <div className="float-right h6 fontNormal pb-2">Wednesday, 1 April 2020</div>
                                            ...
                                            <div className="py-5 " >
                                                <div className="">
                                                    ...
                                                    <div className="row " >
                                                        ...
                                                        <div className=""><span className="h6"><b>$</b></span><span className="h4"><b>24.76</b></span></div>
                                                            <LineChart />
                                                        </div>
                        ...
                        <div className="col-md-7 p-4 pr-3" >
                            ...
                            <div className="bg-white py-5 mr3Mobile" >
                                <div className="px-1">
...
<div className="my-2"><div>Residential</div>
                <div><span className="h5"><b>₦</b></span><span className="h4"><b>36.40</b></span>
...
<div className="mb-4"><div>Commercial</div>
                <div><span className="h5"><b>₦</b></span><span className="h4"><b>52.80</b></span>
                <span className="ml-3"><span className={`${fh4} ${joslaGTextC}`}><i className="fas fa-sort-down"></i></span><span className={joslaGTextC}>42%</span></span></div>
</div>

<div className="mb-4"><div>Industrial</div>
                <div><span className="h5"><b>₦</b></span><span className="h4"><b>58.00</b></span>
                <span className="ml-3"><span className={`${fh4} ${joslaGTextC}`}><i className="fas fa-sort-down"></i></span><span className={joslaGTextC}>42%</span></span></div>
</div>
...
<div className="mx-2  mobileDynamicChart dynamicChartt"><SelectDropDown holderData={"Monthly"}  yearData={yearInreview}/></div>
    ...
    <div className="float-right"><SelectDropDown holderData={"Monthly"}  yearData={yearInreview}/></div>
                            ...
                            <div className="m-3 ">
                                <div className="row">
                                    ...
                                    <div className="text-dark h5">Load generated</div>
                                            ...
                                            <div style={{ borderLeft: '1px solid #000000' }} className="my-5">
                                    ...
                                    <div className="col-md-5  mt-3 removePadLeftRight">
                                        ...
                                        <div className="text-center my-5"><img src="/images/dashboard/analysis.svg" alt="analysis"/></div>
                    {/* Accounting Dept */}
                    <div className="d-flex justify-content-around">
                        <div className="px-1">
                            ...
                            <div className="pt-3"> <span className= {`px-1 text-danger`}><i className="fas fa-exclamation-triangle"></i></span><span className="fontNormal  h6 ml-2">Finance</span> </div>
